...
|-------|-------------|---------|-------------|
| [hive](charts/hive/) | Apache Hive Metastore + HiveServer2 | 0.1.6 | 4.0.0 |
| [trino](charts/trino/) | Trino query engine with password auth, table registration, and Superset integration | 0.2.5 | 481 |

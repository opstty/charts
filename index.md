...
|-------|-------------|---------|-------------|
| [hive](charts/hive/) | Apache Hive Metastore + HiveServer2 | 0.1.7 | 4.0.0 |
| [trino](charts/trino/) | Trino query engine with password auth, table registration, and Superset integration | 0.2.12 | 481 |
